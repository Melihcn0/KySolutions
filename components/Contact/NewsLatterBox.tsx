...
const NewsLatterBox = () => {
  ...
  >
    ...
    <p className="mb-8 border-b border-body-color border-opacity-25 pb-8 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
      Hizmetlerimiz hakkında detaylı bilgi almak için bizimle iletişime
      geçebilirsiniz. İhtiyacınızı dinler, size özel çözümler sunarız.
    </p>
