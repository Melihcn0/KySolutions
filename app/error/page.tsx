...
export const metadata: Metadata = {
  title: "Sayfa Bulunamadı | KySolutions",
  description: "Aradığınız sayfa bulunamadı. KySolutions ana sayfasına dönerek hizmetlerimiz ve çözümlerimiz hakkında bilgi alabilirsiniz.",
};
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  Aradığınız sayfa taşınmış, silinmiş veya mevcut değil gibi görünüyor.
                </p>
                <Link
                  href="/"
